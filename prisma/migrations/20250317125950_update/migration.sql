...
-- CreateIndex
CREATE INDEX "Category_identifier_idx" ON "Category"("identifier");
...
-- AddForeignKey
ALTER TABLE "TestResult" ADD CONSTRAINT "TestResult_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
